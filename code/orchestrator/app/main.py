...
async def process_prompt(req: PromptRequest):
    ...
    1. Sanitizer: Limpa e normaliza o prompt (opcional)
    2. GuardRail: Verifica prompt injection (opcional)
    3. Bias GuardRail: Verifica viés (opcional)
    4. Output GuardRail: Valida resposta (opcional)
